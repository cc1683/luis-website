Vue.component('ls-portfolio-showcase', {
    ...
    data () {
        return {
            portfolioList: [
                {projectImg: 'img/ls-portfolio-1.png', projectName: 'ysWebsite', projectDesc: 'Personal website and resume style site. Build with HTML5, CSS3, Bootstrap4.', projectUrl: 'https://yiing-website.firebaseapp.com'},
                ...
                {projectImg: 'img/ls-portfolio-5.png', projectName: 'My Wiki Site', projectDesc: 'My personal Wiki site that based on October CMS and hosted on DigitalOcean', projectUrl: 'http://luisyctech.tk/'},
            ],
        }
    }
})
