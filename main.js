    ...
    data () {
        return {
            portfolioList: [
                ...
                {projectImg: 'img/ls-portfolio-8.png', projectName: 'Emergency Notification Mobile App', projectDesc: 'A hybrid app that used to send an emergency notification to notify linked family members or friends', projectUrl: 'https://github.com/cc1683/emergency-notification-mobile-app/tree/master/app'},
            ],
        }
    }
})
